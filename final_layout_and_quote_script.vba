...
' Version 4.0: Final Version with Settings Panel
'
...
Public Const AppName As String = "StickerKingVBAScript"
...
Public Sub CreateLayoutAndQuote()
    ...
    ' Get dimensions from the selected shape and the active page.
    ...
    If stickersPerRow <= 0 Then
        MsgBox "The selected sticker is wider than the page, even when rotated.", vbExclamation, "Sticker Too Wide"
        Exit Sub
    End If
    ...
    If totalLayoutHeight > pageHeight Then
        If MsgBox("Warning: The layout is projected to exceed the page height. Continue anyway?", vbYesNo + vbExclamation) = vbNo Then Exit Sub
    End If
    ...
    quoteX = ActivePage.LeftX + pageWidth + 10 ' Position to the right of the page
